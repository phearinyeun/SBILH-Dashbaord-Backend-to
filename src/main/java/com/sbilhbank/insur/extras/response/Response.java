...
import com.sbilhbank.insur.exception.LogicException;
...
public class Response<T> implements Serializable {
    ...
    public static Response ok() {
        return Response.builder()
                ...
                .payload(Map.of("message", "app.common.message.success")).build();
    }
    ...
    public static Response failed(ExpiredJwtException e) {
        return Response.builder().status(HttpStatus.BAD_REQUEST.value())
                .metadata(Metadata.errorBlock(e))
                .payload(ErrorContent.build(e.getMessage()))
                .build();
    }
    public static Response failed(WebClientRequestException e) {
        return Response.builder().status(HttpStatus.INTERNAL_SERVER_ERROR.value())
                .metadata(Metadata.errorBlock(e))
                .payload(ErrorContent.build("Something wrong with JConnect's API",e.getMessage()))
                .build();
    }
    public static Response failed(MethodArgumentNotValidException e) {
        return Response.builder().status(HttpStatus.BAD_REQUEST.value())
                .metadata(Metadata.errorBlock(e))
                .payload(ErrorContent.build("app.common.exception.validation", e))
                .build();
    }
    public static Response failed(BindException e) {
        return Response.builder().status(HttpStatus.BAD_REQUEST.value())
                .metadata(Metadata.errorBlock(e))
                .payload(ErrorContent.build("app.common.exception.validation", e))
                .build();
    ...
    public static Response failed(AuthenticationException e) {
        return Response.builder().status(HttpStatus.UNAUTHORIZED.value())
                .metadata(Metadata.errorBlock(e))
                .payload(ErrorContent.build(getAuthenticationMessage(e), e.getMessage()))
                .build();
    }
    ...
    public static String getAuthenticationMessage(AuthenticationException e) {
        ...
        if (e instanceof UsernameNotFoundException){
            return "app.common.exception.authentication.username-not-found";
        }
    ...
    public static Response failed(DataAccessException e) {
        return Response.builder().status(HttpStatus.INTERNAL_SERVER_ERROR.value())
                .metadata(Metadata.errorBlock(e))
                .payload(ErrorContent.build("app.common.exception.cannot-access-data", e.getMessage()))
                .build();
    }
    ...
    public static Response failed(RuntimeException e) {
        return Response.builder().status(HttpStatus.INTERNAL_SERVER_ERROR.value())
                .metadata(Metadata.errorBlock(e))
                .payload(ErrorContent.build("app.common.exception.runtime-unhandled"))
                .build();
    }
    ...
    public static Response unexpected(Exception e) {
        return Response.builder().status(HttpStatus.INTERNAL_SERVER_ERROR.value())
                .metadata(Metadata.errorBlock(e))
                .payload(ErrorContent.build("app.common.exception.unhandled"))
                .build();
    }
    ...
    public static Response error(Error e) {
        return Response.builder().status(HttpStatus.INTERNAL_SERVER_ERROR.value())
                .metadata(Metadata.errorBlock(e))
                .payload(ErrorContent.build("app.common.exception.system"))
                .build();
    }
    ...
    public final static class ErrorContent implements Serializable {
        ...
        public static ErrorContent build(String message, BindException ex) {
            return new ErrorContent(message, getFailedValidationFields(ex));
        }
        private static Map<String, String> getFailedValidationFields(
                BindException ex) {
